package com.bankhui.h5.test.service.register;
...
public class RegisterTest extends BaseOperation{
	...
	public void register(){
		try{
	        ...
	        // 点击我的
	        this.getDriver().findElement(By.id("a3")).click();
	        
	        // 点击注册或者登陆
	        this.getDriver().findElement(By.className("touIcon")).click();
	        
	        // 点击注册按钮
	        this.getDriver().findElement(By.id("resiBtn")).click();
